...
_atari_prg_bootstrap: CARGS   basepage.l,stack.l
    ...
    move.l  stack(a0),sp                    ; Install or own stack
    move.l  a0,-(sp)                        ; Put BASEPAGE on the stack as expected by the program 
    move.l  #trap1handler,$84               ; Install trap# handler if needed so we can handler Pterm calls
